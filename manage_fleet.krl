...
>>
    ...
    logging on
    shares create_vehicle, __testing, nextId, showChildren, initialize_fleet, vehicles
...
                     "color": "#FF69B4",
  ...
  rule delete_vehicle {
    ...
    pre {
      vehicle_id = event:attrs("vehicle_id"){"vehicle_id"}
	  exists = ent:vehicles.klog("vehicles") >< vehicle_id.klog("Vehicle ID!")
	  eci = meta:eci
